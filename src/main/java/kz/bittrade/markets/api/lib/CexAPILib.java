...
public class CexAPILib {
     ...
     * Cex.io API Secret
     */
    public CexAPILib(String user, String key, String secret) {
        this.username = user;
        this.apiKey = key;
    ...
    /**
     * Debug the contents of the a CexAPILib Object.
     *
     * @return The CexAPILib object data: username, apiKey, apiSecret, and nonce.
     */
